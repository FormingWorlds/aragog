...
class EntropyEOS:
    ...
    def heat_capacity(self, P: npt.NDArray | float,
        ...
        Linear phase-weighted blend of the solid and melt P-S tables.
        This standalone helper is the table-only Cp; the production
        flux operator uses the latent-heat-augmented mushy-zone Cp
        formula inlined directly in EntropyPhaseEvaluator._update_eos.
        """
