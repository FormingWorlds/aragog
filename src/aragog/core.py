...
#
"""Backward compatibility shim. Import from aragog.solver.boundary and aragog.solver.initial."""

from aragog.solver.boundary import BoundaryConditions  # noqa: F401
from aragog.solver.initial import InitialCondition  # noqa: F401
