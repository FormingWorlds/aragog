...
def main():
    ...
    def with_flags(cond=False, conv=False, grav=False, mix=False, dil=False):
        return PhaseParams(
            ...
            enabled=params0.enabled,
            activation_energy=params0.activation_energy,
            ...
            viscosity_max_log10=params0.viscosity_max_log10,
            lid_base_mode=params0.lid_base_mode,
            lid_base_temperature=params0.lid_base_temperature,
            lid_contrast_coeff=params0.lid_contrast_coeff,
        )
